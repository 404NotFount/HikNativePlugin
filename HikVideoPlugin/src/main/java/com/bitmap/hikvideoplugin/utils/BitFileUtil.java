...
public class BitFileUtil {
    ...
    public static boolean rename(File file, String newName) {
        ...
        // 新的文件名为空返回false
        if (BitStringUtil.isEmpty(newName)) return false;
        // 如果文件名没有改变返回true
...
//            file.createNewFile();
    ...
    public static File copyFile(String fromFilePath, String toFilePath) {
        ...
        try {
            ...
            BitLogUtil.loge(cFromFile + e.getMessage());
            return null;
        }
        ...
        try {
            ...
            BitLogUtil.loge(ctoFile + e.getMessage());
            return null;
        }

        if (!fromFile.exists()) {
            BitLogUtil.loge(urlNull);
            return null;
        }
        if (!fromFile.isFile()) {
            BitLogUtil.loge(isFile);
            return null;
        }
        if (!fromFile.canRead()) {
            BitLogUtil.loge(canRead);
            return null;
        }
        ...
        try {
            ...
            e.printStackTrace();
            BitLogUtil.loge(copyFalse + e.getMessage());
            return null;
        }
        return toFile;
    }
    ...
    public static String getFileExtension(String filePath) {
        if (BitStringUtil.isEmpty(filePath)) return filePath;
