...
import static com.bitmap.hikvideoplugin.myApp.getContext;


public class BitRecordUtil {
    ...
    private BitRecordListener recordListener;

    public BitRecordUtil(Context context) {
    ...
    //录音监听
    public void setOnRecordListener(BitRecordListener recordListener) {
    ...
    private void initDialogAndStartRecord() {
        ...
        View contentView = LayoutInflater.from(context).inflate(R.layout.dialog_recordbutton_alert_dialog, null);
...
//        mRecorder.setOutputFormat(MediaRecorder.OutputFormat.DEFAULT);
    ...
    public void playMedia(String path) {
        if (path != null && BitFileUtil.isFileExists(path)) {
    ...
    public void playMedia(Uri uri) {
        ...
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                animation.stop();
                timer.cancel();
                mListener.onPlayMediaFinish(1);
            }
        });
    }

    private OnPlayMediaStateListener mListener;

    /**
     *  定义一个接口
     *  用于播放录音完成后回调
     */
    public interface OnPlayMediaStateListener {
     ...
     *  写一个设置接口监听的方法
     */
    public void setPlayMediaStateListener(OnPlayMediaStateListener listener) {
        mListener = listener;
    }
    ...
    private void initPlayingDialog() {
        ...
        View contentView = LayoutInflater.from(context).inflate(R.layout.dialog_playing_dialog, null);
